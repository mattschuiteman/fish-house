...
struct LongColumnBoxView: View {
    ...
    let horizontalPadding: CGFloat = 32.5
...
struct LongColumnBoxView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        GeometryReader {geo in
            LongColumnBoxView(geometryHeight: geo.size.height, geometryWidth: geo.size.width, leftRequestedWeight: 0, rightRequestedWeight: 95, leftColor: .purple, rightColor: .red, rightTitle: "ATH")
