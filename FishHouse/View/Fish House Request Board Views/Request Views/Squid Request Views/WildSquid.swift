...
struct WildSquid: View {
    ...
    let leftName: String = "wild_little"
    let rightName: String = "wild_big"
...
struct WildSquid_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{geo in
            WildSquid(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width)
        }
