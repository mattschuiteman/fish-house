...
struct ShowSquid: View {
    ...
    let leftName: String = "show_little"
    let rightName: String = "show_big"
...
struct ShowSquid_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{geo in
            ShowSquid(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width)
        }
