...
struct PointSquid: View {
    ...
    let leftName: String = "point_little"
    let rightName: String = "point_big"
...
struct PointSquid_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{geo in
            PointSquid(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width)
        }
