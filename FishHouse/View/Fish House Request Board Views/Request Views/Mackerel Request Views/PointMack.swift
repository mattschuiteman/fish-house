...
struct PointMack_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{geo in
            PointMack(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width)
        }
    }
}
