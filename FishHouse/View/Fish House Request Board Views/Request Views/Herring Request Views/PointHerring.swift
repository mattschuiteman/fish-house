...
struct PointHerring: View {
    ...
    let pac: String = "point_pac"
    let atl: String = "point_atl"
    let large: String = "point_large"
...
struct PointHerring_Previews: PreviewProvider {
    static var previews: some View {
        
        GeometryReader { geo in
            PointHerring(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width, isEditable: true)
        }
