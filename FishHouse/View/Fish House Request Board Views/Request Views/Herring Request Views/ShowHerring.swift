...
struct ShowHerring: View {
    ...
    let pac: String = "show_pac"
    let atl: String = "show_atl"
    let large: String = "show_large"
...
struct ShowHerring_Previews: PreviewProvider {
    static var previews: some View {
        
        GeometryReader {geo in
            ShowHerring(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width, isEditable: true)
        }
