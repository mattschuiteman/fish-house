...
struct WildHerring: View {
    ...
    let pac: String = "wild_pac"
    let atl: String = "wild_atl"
    let large: String = "wild_large"
...
struct WildHerring_Previews: PreviewProvider {
    static var previews: some View {
        
        GeometryReader { geo in
            WildHerring(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width, isEditable: true)
        }
