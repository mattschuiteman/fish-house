...
struct WhaleHerring: View {
    ...
    let pac: String = "whale_pac"
    let atl: String = "whale_atl"
    let large: String = "whale_large"
    
    let atlAbbrev: String = "ATL"
...
struct WhaleHerring_Previews: PreviewProvider {
    static var previews: some View {
        
        GeometryReader {geo in
            WhaleHerring(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width, isEditable: true)
        }
