...
struct WildCapelin_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{geo in
            WildCapelin(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width)
        }
    }
}
