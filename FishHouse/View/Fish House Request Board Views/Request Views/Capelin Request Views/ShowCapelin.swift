...
struct ShowCapelin_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{geo in
            ShowCapelin(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width)
        }
    }
}
