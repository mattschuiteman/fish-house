...
struct WhaleSards_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{geo in
            WhaleSards(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width)
        }
    }
}
