...
struct PinnSards_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{geo in
            PinnSards(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width)
        }
    }
}
