...
struct ShowSards_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{geo in
            ShowSards(requests: FishHouseRequests(), geometryHeight: geo.size.height, geometryWidth: geo.size.width)
        }
    }
}
